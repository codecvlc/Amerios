...
#if defined(NDEBUG)
# error "Amerios cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x7b175de869013e682b41ccac088a269f7e4e03af5b50d662fc2515a107a4d1f5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Amerios: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Amerios Signed Message:\n";
...
{
    // Amerios: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Amerios: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Amerios: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7b175de869013e682b41ccac088a269f7e4e03af5b50d662fc2515a107a4d1f5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1433256124, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "02/Jun/2015 Deutsche Welle augura la desaparicion de la Union Europea";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xc303b0e850eb8094c7bd0f833bd91bb785cef407b5306871b81f13d25f879ef5"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Amerios: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AmeriosMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AmeriosMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AmeriosMiner(CWallet *pwallet)
{
    printf("AmeriosMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("amerios-miner");
    ...
    try { loop {
        ...
        printf("Running AmeriosMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AmeriosMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AmeriosMiner, pwallet));
}
